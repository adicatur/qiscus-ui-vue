...
**Qiscus SDK Js File**
```
https://qiscus-sdk.s3-ap-southeast-1.amazonaws.com/web/v2.8.1/qiscus-sdk.2.8.1.js
```
**Qiscus SDK Css File**
```
https://qiscus-sdk.s3-ap-southeast-1.amazonaws.com/web/v2.8.1/qiscus-sdk.2.8.1.css
```
We also provide CDN for production purpose with compression enabled.
**Qiscus SDK for Production**
```
https://d3p8ijl4igpb16.cloudfront.net/web/v2.8.1/qiscus-sdk.2.8.1.js
https://d3p8ijl4igpb16.cloudfront.net/web/v2.8.1/qiscus-sdk.2.8.1.css
```
